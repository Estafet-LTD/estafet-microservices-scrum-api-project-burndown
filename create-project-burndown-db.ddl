...
create table PROJECT_BURNDOWN_SPRINT (PROJECT_BURNDOWN_SPRINT_ID int4 not null, endDate varchar(255), SPRINT_NUMBER int4 not null, POINTS_TOTAL int4, projectId int4, startDate varchar(255), STATUS varchar(255) not null, PROJECT_BURNDOWN_ID int4, primary key (PROJECT_BURNDOWN_SPRINT_ID))
