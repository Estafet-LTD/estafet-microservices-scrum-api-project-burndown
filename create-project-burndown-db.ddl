...
create table PROJECT_BURN_SPRINT (SPRINT_ID int4 not null, SPRINT_NUMBER int4, POINTS_TOTAL int4, projectId int4, status varchar(255), PROJECT_ID int4, primary key (SPRINT_ID));
