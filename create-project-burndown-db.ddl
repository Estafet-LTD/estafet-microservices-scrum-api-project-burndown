...
create table PROJECT_BURNDOWN_SPRINT (PROJECT_BURNDOWN_SPRINT_ID int4 not null, END_DATE varchar(255) not null, SPRINT_NUMBER int4 not null, POINTS_TOTAL int4, START_DATE varchar(255) not null, STATUS varchar(255) not null, PROJECT_BURNDOWN_ID int4, primary key (PROJECT_BURNDOWN_SPRINT_ID));
