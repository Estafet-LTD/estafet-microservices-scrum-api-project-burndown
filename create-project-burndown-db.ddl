...
alter table PROJECT_BURNDOWN_SPRINT add constraint PB_SPRINT_TO_PROJECT_BURNDOWN_FK foreign key (PROJECT_BURNDOWN_ID) references PROJECT_BURNDOWN;
alter table PROJECT_BURNDOWN_STORY add constraint PB_STORY_TO_PROJECT_BURNDOWN_FK foreign key (PROJECT_BURNDOWN_ID) references PROJECT_BURNDOWN;
